...
function ManageProducts(){
    ...
    useEffect(()=>{
         api.get('/api/products', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }).then(res=>setProducts(res.data))
    },[])
                        ...
                        <div className="relative h-48 bg-gray-100 dark:bg-gray-700">
                          {product.images?.[0] ? (
                            <img
                              ...
                              onError={(e) => {
                                console.error('Product list image failed to load:', product.images[0]);
